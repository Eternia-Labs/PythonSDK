...
class SCBi:
    ...
    def getReportingServicesForPrincipalOrg(self, org, pid, expJson, propid=None, client=None):
        if client == "Sync":
    ...
    def getReportingServicesForPrincipalBuilding(self, org, pid, expJson, propid=None, client=None):
        if client == "Sync":
            res = self.Sync_client.makeRequest(
                httpmethod="POST",
