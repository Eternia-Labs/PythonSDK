...
class SCDeviceManagement:
    ...
    def realSenseMigrated(self, org, pid, propid=None, client=None):
        if client == "Sync":
    ...
    def getDeviceSlots(self, org, pid, expJson, propid=None, client=None):
        if client == "Sync":
            res = self.Sync_client.makeRequest(
                httpmethod="POST",
