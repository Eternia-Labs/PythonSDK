...
class SCGrids:
    ...
    def read_zone(self, org: str, pid: str, exp_json: str, propid=None, client=None) -> any:
        """
    ...
    def listZonesByLevel(self, org, pid, expJson, propid=None, client=None):
        if client == "Sync":
            res = self.Sync_client.makeRequest(
                httpmethod="POST",
    ...
    def buildingZoneMap(self, org, pid, expJson, propid=None, client=None):
        if client == "Sync":
            res = self.Sync_client.makeRequest(
                httpmethod="POST",
